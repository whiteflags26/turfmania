          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 flex items-center justify-between border-b border-gray-100">
                ...
                >
                  <FiChevronRight className={`h-5 w-5 text-gray-500 transform transition-transform ${isCollapsed ? '' : 'rotate-180'}`} />
                </button>
              </div>

              {/* User Profile Section */}
              <div className={`border-b border-gray-100 py-4 px-3 ${isCollapsed ? 'flex justify-center' : ''}`}>
                {!isCollapsed ? (
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-grow overflow-hidden">
                      <p className="font-medium text-gray-800 truncate">{user?.email || "User"}</p>
                      <p className="text-xs text-gray-500 truncate">Organization Owner</p>
                    </div>
                  </div>
                ) : (
                    ...
                    return (
                      <li key={item.name}>
                        <Link href={item.path} passHref>
                          <div
                            className={`flex items-center px-3 py-3 rounded-xl cursor-pointer transition-all ${
                              isActive 
              ...
              <div className={`p-4 border-t border-gray-100 ${isCollapsed ? 'flex justify-center' : ''}`}>
                <button 
                  onClick={() => logout()} 
                  className={`flex items-center text-gray-600 hover:text-red-600 transition-colors ${isCollapsed ? 'justify-center p-2' : 'px-3 py-2'}`}
                >
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="border-b border-gray-100 py-4 px-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow overflow-hidden">
                        <p className="font-medium text-gray-800 truncate">{user?.email || "User"}</p>
                        <p className="text-xs text-gray-500">Organization Owner</p>
                      </div>
                    </div>
                  </div>
