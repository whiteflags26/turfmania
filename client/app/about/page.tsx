...
import { FiArrowRight, FiMapPin, FiStar, FiCalendar, FiUsers, FiDollarSign, FiShield } from "react-icons/fi";
          ...
          >
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                At TurfMania, we are streamlining the turf industry in Bangladesh by connecting sports enthusiasts with quality venues. 
                Our platform simplifies the booking process, empowers turf owners, and creates a vibrant sports community.
              </p>
              <p className="text-lg text-gray-600">
                Whether you are organizing a casual game with friends or managing multiple sports facilities, TurfMania provides the tools and technologies to make your experience seamless.
              </p>
            </div>
            <motion.div
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                <div className="p-6 text-white">
                  <h3 className="text-xl font-bold">Your Game, Your Turf, Your Time</h3>
                  <p className="text-sm opacity-90">Experience sports booking reimagined</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              TurfMania offers a comprehensive suite of features designed for players, turf owners, and administrators.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How TurfMania Works</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our platform connects players with turf owners through an intuitive, streamlined process.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              {
                title: "Search",
                description: "Find turfs based on location, sport, price, and availability",
                icon: "/images/Hero-id1.avif",
                step: "01",
              },
              {
                title: "Book",
                description: "Select your preferred time slot and complete payment",
                icon: "/images/Hero-id4.avif",
                step: "02",
              },
              {
                title: "Play",
                description: "Show up and enjoy your game with friends or teammates",
                icon: "/images/Hero-id9.avif",
                step: "03",
              },
              {
                title: "Review",
                description: "Share your experience to help other players",
                icon: "/images/Hero-id12.avif",
                step: "04",
              }
            ].map((item, index) => (
              <motion.div
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/venues">
                <Button variant="default" className="flex items-center gap-2 font-semibold">
